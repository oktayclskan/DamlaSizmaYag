<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="OliveOilBenfitsBlog.aspx.cs" Inherits="DamlaYağ.OliveOilBenfitsBlog" %>
                    ...
                    <div ng-repeat="x in veri" class="col-md-4 mt-5" >
                        <div class="card" style="width: 25rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="BlogReadBenfits.aspx" class="btn btn-success">Devamını Okuyun >></a>
                            </div>
                        </div>
                    </div>
                </div>
     ...
     <script>
        ...
        app.controller('GetData', function ($scope, $http) {
            $http.get("Master.json").then(function (response) {
                $scope.veri = response.data.OliveOilBenefitsBlog;
            });
        });
     </script>
</asp:Content>
