<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Product2.aspx.cs" Inherits="DamlaYağ.Product2" %>
            ...
            <div ng-repeat="x in veri">
                <div class="row">
                    <div class="col-md-6 text-center">
                        <img src="Assetss/ProductImage/NaturalOlive/u1imgZeytin.png" width="420" />
                    </div>
    ...
    <script>
        ...
        app.controller('GetData', function ($scope, $http) {
            $http.get("Master.json").then(function (response) {
                $scope.veri = response.data.ContentProductOlive;
            });
        });
    </script>
</asp:Content>
