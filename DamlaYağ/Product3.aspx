<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Product3.aspx.cs" Inherits="DamlaYağ.Product3" %>
            ...
            <div ng-repeat="x in veri">
                <div class="row">
                    <div class="col-md-6 text-center">
                        <img src="Assetss/ProductImage/OliveOilSoap/u2Soap.jpg" width="420" />
                    </div>
    ...
    <script>
        ...
        app.controller('GetData', function ($scope, $http) {
            $http.get("Master.json").then(function (response) {
                $scope.veri = response.data.ContentProductOliveSoap;
            });
        });
    </script>
</asp:Content>
